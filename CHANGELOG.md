...
* [`eacd052`](https://github.com/northwood-labs/tomlrt-cli/commit/eacd052531b1b9c74959cac12d181c7638ff2a4e): **deps**: Bump `actions/checkout` from 6.0.2 to 6.0.3 ([#1](@REPO/issues/1)) ([@dependabot](https://github.com/dependabot))
* [`8c857d6`](https://github.com/northwood-labs/tomlrt-cli/commit/8c857d6c84d0f436efbfb59ddd1d4e965bab2565): **deps**: Bump `step-security/harden-runner` from 2.19.3 to 2.19.4 ([#2](@REPO/issues/2)) ([@dependabot](https://github.com/dependabot))

### <!-- 0 -->:rocket: Features

* [`cf37132`](https://github.com/northwood-labs/tomlrt-cli/commit/cf371321a430f7fef1fd71e4ad0c2e986b82e7a6): Initial commit. ([@skyzyx](https://github.com/skyzyx))
* [`fefdd63`](https://github.com/northwood-labs/tomlrt-cli/commit/fefdd632ad97d13823032735a4d2f9a784e9fa36): Add automated changelog and contributors workflow. ([@skyzyx](https://github.com/skyzyx))
